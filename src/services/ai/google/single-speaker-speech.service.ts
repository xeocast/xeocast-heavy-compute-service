...
export const generateSingleSpeakerAudioWithGemini = async (
  text: string,
  ...
  return uploadAudioAndReturnResponse(audioPart, output_bucket_key, taskId, SingleSpeakerSpeechResponseSchema);
};
